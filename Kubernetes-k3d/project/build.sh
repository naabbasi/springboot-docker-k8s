...
docker rmi go-web-server:latest && docker rmi k3d-registry.localhost:5050/go-web-server:v1.0
...
kubectl delete deployment go-web-server && kubectl delete svc go-web-server
